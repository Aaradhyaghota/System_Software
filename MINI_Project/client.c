...
void connection_handler(int sockFD) {
    ...
    char rBuffer[1000], wBuffer[1000];  // A buffer used for reading from /
                                        // writting to the server
    ssize_t readBytes,
        writeBytes;  // Number of bytes read from / written to the socket
...
void main() {
    ...
    connectStatus = connect(socketFd, (struct sockaddr *)&serverAddress,
